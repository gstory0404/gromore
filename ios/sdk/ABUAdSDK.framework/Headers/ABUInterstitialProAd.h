...
/// 广告代理对象
@property (nonatomic, weak, nullable) id<ABUInterstitialProAdDelegate> delegate;
...
- (BOOL)showAdFromRootViewController:(UIViewController *)viewController extraInfos:(nullable NSDictionary *)extraInfos;
