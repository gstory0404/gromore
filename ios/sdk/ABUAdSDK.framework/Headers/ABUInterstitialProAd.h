...
- (BOOL)showAdFromRootViewController:(UIViewController *_Nonnull)viewController extroInfos:(NSDictionary *_Nullable)extroInfos ABU_DEPRECATED_MSG_ATTRIBUTE("接口即将废弃，请使用`showAdFromRootViewController:extraInfos:`代替");
