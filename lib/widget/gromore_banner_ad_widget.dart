...
class GromoreBannerAd extends StatefulWidget {
  ...
  /// [height] 高
  ///
  /// [callBack] 广告回调，具体查看[GromoreBannerCallBack]
  ///
  GromoreBannerAd(
      {Key? key,
  ...
  @override
  State<GromoreBannerAd> createState() => _GromoreBannerAdState();
}

class _GromoreBannerAdState extends State<GromoreBannerAd> {
  final String _viewType = "com.gstory.gromore/BannerAdView";
